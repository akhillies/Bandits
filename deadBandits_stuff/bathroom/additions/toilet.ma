...
//Name: toilet.ma
//Last modified: Fri, Nov 28, 2014 10:53:58 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -174.32790601937717 138.70117936776199 317.10253693032206 ;
	setAttr ".r" -type "double3" -18.338352729608488 -29.000000000004473 0 ;
	setAttr ".rp" -type "double3" 0 2.1316282072803009e-14 0 ;
	setAttr ".rpt" -type "double3" -3.757928704003912e-16 -2.3808150733873746e-15 -9.7821649260227119e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 392.73136567016383;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -16.116817504578229 -11.052152086228077 6.3371735941738638 ;
