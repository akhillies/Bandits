...
//Name: PIG_collar_pxr.ma
//Last modified: Sat, Apr 25, 2015 02:28:03 PM
//Codeset: 1252
requires maya "2015";
requires -nodeType "RenderMan" -nodeType "PxrTangentField" -nodeType "PxrVoronoise"
		 -nodeType "PxrClamp" -nodeType "PxrTexture" -nodeType "PxrDisney" -nodeType "PxrLMMetal"
		 -nodeType "PxrManifold2D" "RenderMan_for_Maya" "5.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.253883814406642 1.8973255843557526 4.1814307223413589 ;
	setAttr ".r" -type "double3" -15.338352730090863 -74.99999999995272 6.1443598174814964e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 14.22703579394838;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" -4.7651024100974446 -1.7256332301709633e-031 -1.1837876359015098 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -4.9072267707038222 -2.4651903288156619e-032 0.38992693246381549 ;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" -4.5665175866446974 1.1093356479670479e-031 1.8502001351488673 ;
	setAttr ".r" -type "double3" 17.113462665476185 1.590277340731758e-015 89.999999999999901 ;
	setAttr ".s" -type "double3" 1 0.12664326563503717 1 ;
createNode mesh -n "pCubeShape3" -p "pCube3";
	...
	setAttr ".pt[16]" -type "float3" 0.033326659 0 -3.7252903e-009 ;
	setAttr ".pt[34]" -type "float3" 0.033326659 0 -3.7252903e-009 ;
	...
	setAttr ".pt[62]" -type "float3" 0.033326659 0.090831295 -3.7252903e-009 ;
	...
	setAttr ".pt[92]" -type "float3" 0.033326659 0 -3.7252903e-009 ;
	...
	setAttr ".pt[171]" -type "float3" 0.033326659 0 -3.7252903e-009 ;
	setAttr ".pt[172]" -type "float3" 0.033326659 0.090831295 -3.7252903e-009 ;
	setAttr ".pt[173]" -type "float3" 0.033326659 0 -3.7252903e-009 ;
	setAttr ".pt[174]" -type "float3" 0.033326659 0 -3.7252903e-009 ;
...
createNode transform -n "pCube4";
	setAttr ".t" -type "double3" -1.7757606217414619 7.3955709864469857e-031 4.5019912776905437 ;
...
createNode mesh -n "pCubeShape4" -p "pCube4";
	...
	setAttr ".pt[56]" -type "float3" -1.0408341e-017 -0.64341182 0 ;
	setAttr ".pt[59]" -type "float3" -1.0408341e-017 -0.64341182 0 ;
	setAttr ".pt[61]" -type "float3" 1.6479873e-017 -0.64341182 0 ;
	setAttr ".pt[62]" -type "float3" 1.6479873e-017 -0.64341182 0 ;
	setAttr ".pt[64]" -type "float3" 0 -0.64341182 0 ;
	setAttr ".pt[65]" -type "float3" 0 -0.64341182 0 ;
	setAttr ".pt[66]" -type "float3" 1.6479873e-017 -0.64341182 0 ;
	...
	setAttr ".pt[76]" -type "float3" -1.0408341e-017 -0.64341182 0 ;
	...
	setAttr ".pt[86]" -type "float3" 1.6479873e-017 -0.64341182 0 ;
	...
	setAttr ".pt[96]" -type "float3" -1.0408341e-017 -0.64341182 0 ;
	...
	setAttr ".pt[116]" -type "float3" -1.4901161e-008 0.87873304 7.4505806e-009 ;
	setAttr ".pt[117]" -type "float3" 1.4901161e-008 2.3841858e-007 7.4505806e-009 ;
	setAttr ".pt[119]" -type "float3" -4.6566129e-010 1.1920929e-007 0 ;
	setAttr ".pt[121]" -type "float3" 1.4901161e-008 -4.7683716e-007 7.4505806e-009 ;
	...
	setAttr ".pt[125]" -type "float3" 3.7252903e-009 1.1920929e-007 3.7252903e-009 ;
	setAttr ".pt[126]" -type "float3" 0 4.7683716e-007 0 ;
	setAttr ".pt[127]" -type "float3" 1.4901161e-008 4.7683716e-007 -7.4505806e-009 ;
	setAttr ".dr" 3;
	setAttr ".dsm" 2;
...
createNode transform -n "pCylinder2";
	setAttr ".t" -type "double3" -3.9553602770266698 -2.4651903288156619e-032 2.6411010559826837 ;
...
createNode transform -n "pCylinder3";
	setAttr ".t" -type "double3" -4.0566388101156132 1.7256332301709633e-031 -2.561316232107115 ;
...
createNode mesh -n "pCylinderShape3" -p "pCylinder3";
	...
	setAttr -s 26 ".vt[0:25]"  0.1557197 -0.23631351 -0.26971427 -0.15571958 -0.23631351 -0.26971433
		 -0.31143925 -0.23631351 -4.6408065e-008 -0.15571965 -0.23631351 0.2697143 0.15571961 -0.23631351 0.26971433
		 ...
		 -0.15571965 0.18779872 0.2697143 -0.31143925 0.18779872 -4.6408065e-008 -0.15571958 0.18779872 -0.26971433
		 0.1557197 0.18779872 -0.26971427 0.31143925 -0.17222866 0 0.15571961 -0.17222866 0.26971433
		 -0.15571965 -0.17222866 0.2697143 -0.31143925 -0.17222866 -4.6408065e-008 -0.15571958 -0.17222866 -0.26971433
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "                -keyReleaseCommand \"nodeEdKeyReleaseCommand\" \n                -nodeTitleMode \"name\" \n                -gridSnap 0\n                -gridVisibility 1\n                -popupMenuScript \"nodeEdBuildPanelMenus\" \n                -showNamespace 1\n                -showShapes 1\n                -showSGShapes 0\n                -showTransforms 1\n                -useAssets 1\n                -syncedSelection 1\n                -extendToShapes 1\n                $editorName;\n\t\t\tif (`objExists nodeEditorPanel2Info`) nodeEditor -e -restoreInfo nodeEditorPanel2Info $editorName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\tif ($useSceneConfig) {\n\t\tscriptedPanel -e -to $panelName;\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"left3\\\" -ps 1 28 40 -ps 2 72 100 -ps 3 28 60 $gMainPane;\"\n"
...
createNode polySplitRing -n "polySplitRing35";
	...
	setAttr ".ix" -type "matrix" 2.2204460492503131e-016 1 0 0 -0.27048124702510229 6.0058901635318638e-017 0 0
...
createNode polySplitRing -n "polySplitRing45";
	...
	setAttr ".ix" -type "matrix" 2.9357753817472178e-016 1.3221556915280246 0 0 -0.14545604108327345 3.2297729176294577e-017 0 0
...
createNode polyTweak -n "polyTweak9";
	...
	setAttr ".tk[3]" -type "float3" 2.9592633e-007 -0.0023744521 -0.58409631 ;
	...
	setAttr ".tk[7]" -type "float3" -0.58409637 -0.0023744521 -2.3328951e-007 ;
	...
	setAttr ".tk[11]" -type "float3" -8.7037101e-008 -0.0023744521 0.58409625 ;
	...
	setAttr ".tk[15]" -type "float3" 0.58409637 -0.0023744521 -2.4400268e-008 ;
	...
	setAttr ".tk[51]" -type "float3" 2.9592621e-007 0.0023744521 -0.58409643 ;
	...
	setAttr ".tk[55]" -type "float3" -0.58409655 0.0023744521 -2.3328954e-007 ;
	...
	setAttr ".tk[59]" -type "float3" -8.703708e-008 0.0023744521 0.58409643 ;
	...
	setAttr ".tk[63]" -type "float3" 0.58409655 0.0023744521 -2.4400276e-008 ;
createNode polyExtrudeFace -n "polyExtrudeFace2";
	...
	setAttr ".cbx" -type "double3" -7.3857825533265854e-007 0.8126933988359113 4.956514851869783 ;
...
createNode polySplitRing -n "polySplitRing64";
	...
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode PxrLMMetal -n "PxrSteel";
	setAttr ".anisotropy" 0.60000002384185791;
createNode shadingEngine -n "PxrLMMetal1SG";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode PxrDisney -n "PxrCollar";
	setAttr ".baseColor" -type "float3" 0.067000002 0 0 ;
	setAttr ".specular" 0.40000000596046448;
	setAttr ".roughness" 0.60000002384185791;
createNode shadingEngine -n "PxrDisney1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
createNode PxrLMMetal -n "PxrNameMetal";
	setAttr ".specularColor" -type "float3" 1 0.71281374 0 ;
...
createNode hyperView -n "hyperView1";
	setAttr ".vl" -type "double2" -2322.6433626278035 -743.60758173380862 ;
	setAttr ".vh" -type "double2" -828.24560352416199 67.141717986079314 ;
	setAttr ".dag" no;
createNode hyperLayout -n "hyperLayout1";
	...
	setAttr ".hyp[2].x" -25.595237731933594;
	setAttr ".hyp[2].y" -1.4285714626312256;
	setAttr ".hyp[2].nvs" 1920;
	setAttr ".hyp[3].x" -25.595237731933594;
	setAttr ".hyp[3].y" -151.42857360839844;
	setAttr ".hyp[3].nvs" 1920;
	setAttr ".hyp[4].x" -25.595237731933594;
	setAttr ".hyp[4].y" 219.64285278320312;
	setAttr ".hyp[4].nvs" 1920;
	setAttr ".hyp[5].x" 171.54762268066406;
	setAttr ".hyp[5].y" 240.4761962890625;
	setAttr ".hyp[5].nvs" 1920;
	setAttr ".hyp[6].x" 171.54762268066406;
	setAttr ".hyp[6].y" 161.90475463867187;
	setAttr ".hyp[6].nvs" 1920;
	setAttr ".hyp[7].x" -25.595237731933594;
	setAttr ".hyp[7].y" 219.64285278320312;
	setAttr ".hyp[7].nvs" 1920;
	setAttr ".hyp[8].x" 171.54762268066406;
	setAttr ".hyp[8].y" 83.333335876464844;
	setAttr ".hyp[8].nvs" 1920;
	setAttr ".hyp[9].x" -955.05291748046875;
	setAttr ".hyp[9].y" -122.87036895751953;
	setAttr ".hyp[9].nvs" 1920;
	setAttr ".hyp[10].x" -955.05291748046875;
	setAttr ".hyp[10].y" -44.298942565917969;
	setAttr ".hyp[10].nvs" 1920;
	setAttr ".hyp[11].x" -1132.55517578125;
	setAttr ".hyp[11].y" -336.03622436523437;
	setAttr ".hyp[11].nvs" 1920;
	setAttr ".hyp[12].x" -1249.5106201171875;
	setAttr ".hyp[12].y" -44.298942565917969;
	setAttr ".hyp[12].nvs" 1920;
	setAttr ".hyp[13].x" -2103.822265625;
	setAttr ".hyp[13].y" -118.10922241210937;
	setAttr ".hyp[13].nvs" 1920;
	setAttr ".hyp[14].x" -1753.3194580078125;
	setAttr ".hyp[14].y" -88.958778381347656;
	setAttr ".hyp[14].nvs" 1920;
	setAttr ".hyp[15].x" -1435.8695068359375;
	setAttr ".hyp[15].y" -259.26882934570312;
	setAttr ".hyp[15].nvs" 1920;
	setAttr ".hyp[16].x" -1402.6783447265625;
	setAttr ".hyp[16].y" -499.43728637695312;
	setAttr ".hyp[16].nvs" 1920;
	setAttr ".hyp[17].x" -1749.891845703125;
	setAttr ".hyp[17].y" -281.09228515625;
	setAttr ".hyp[17].nvs" 1920;
	setAttr ".anf" yes;
createNode PxrLMMetal -n "PxrStuds";
	setAttr ".specularColor" -type "float3" 1 0.9113152 0.40399998 ;
createNode shadingEngine -n "PxrLMMetal3SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo4";
createNode PxrLMMetal -n "PxrGlitter";
	setAttr ".roughness" 0.5;
	setAttr ".anisotropy" -0.99000000953674316;
	setAttr ".specularColor" -type "float3" 1 0.71077836 0 ;
createNode shadingEngine -n "PxrLMMetal4SG";
	setAttr ".ihi" 0;
	setAttr -s 5 ".dsm";
	setAttr ".ro" yes;
...
createNode PxrClamp -n "PxrClamp1";
	setAttr ".min" -type "float3" 0.32800001 0.32800001 0.32800001 ;
createNode hyperGraphInfo -n "nodeEditorPanel2Info";
createNode hyperView -n "hyperView2";
	setAttr ".vl" -type "double2" -401.05125732593865 -906.94732054418955 ;
	setAttr ".vh" -type "double2" 711.80012925574692 255.94663374245411 ;
	setAttr ".dag" no;
createNode hyperLayout -n "hyperLayout2";
	...
	setAttr ".hyp[2].nvs" 1920;
	setAttr ".hyp[3].x" 211.40681457519531;
	setAttr ".hyp[3].y" -314.69305419921875;
	setAttr ".hyp[3].nvs" 1922;
	setAttr ".hyp[4].x" -326.487060546875;
	setAttr ".hyp[4].y" 94.19158935546875;
	setAttr ".hyp[4].nvs" 1920;
	setAttr ".hyp[5].x" -387.99972534179687;
	setAttr ".hyp[5].y" -112.85368347167969;
	setAttr ".hyp[5].nvs" 1920;
	setAttr ".hyp[6].x" -132.50816345214844;
	setAttr ".hyp[6].y" -113.64593505859375;
	setAttr ".hyp[6].nvs" 1920;
	setAttr ".hyp[7].x" -106.7532958984375;
	setAttr ".hyp[7].y" -429.15994262695312;
	setAttr ".hyp[7].nvs" 1920;
	setAttr ".hyp[8].x" 157.75741577148437;
	setAttr ".hyp[8].y" -737.55023193359375;
	setAttr ".hyp[8].nvs" 1920;
	setAttr ".anf" yes;
createNode PxrTangentField -n "PxrTangentField1";
createNode PxrTexture -n "PxrTexture1";
	setAttr ".filename" -type "string" "C:/Users/Brian/Documents/GitHub/Bandits/Bandits/maya/sourceimages/aniso_vec_circles.tex";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
relationship "link" ":lightLinker1" "PxrLMMetal2SG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "PxrLMMetal3SG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "PxrLMMetal4SG.message" ":defaultLightSet.message";
...
relationship "shadowLink" ":lightLinker1" "PxrLMMetal2SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "PxrLMMetal3SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "PxrLMMetal4SG.message" ":defaultLightSet.message";
...
connectAttr "PxrSteel.oc" "PxrLMMetal1SG.ss";
connectAttr "pCubeShape5.iog" "PxrLMMetal1SG.dsm" -na;
connectAttr "pCubeShape4.iog" "PxrLMMetal1SG.dsm" -na;
connectAttr "PxrLMMetal1SG.msg" "materialInfo1.sg";
connectAttr "PxrSteel.msg" "materialInfo1.m";
connectAttr "PxrSteel.msg" "materialInfo1.t" -na;
connectAttr "PxrCollar.oc" "PxrDisney1SG.ss";
connectAttr "pCylinderShape1.iog" "PxrDisney1SG.dsm" -na;
connectAttr "PxrDisney1SG.msg" "materialInfo2.sg";
connectAttr "PxrCollar.msg" "materialInfo2.m";
connectAttr "PxrCollar.msg" "materialInfo2.t" -na;
connectAttr "PxrNameMetal.oc" "PxrLMMetal2SG.ss";
connectAttr "PxrLMMetal2SG.msg" "materialInfo3.sg";
connectAttr "PxrNameMetal.msg" "materialInfo3.m";
connectAttr "PxrNameMetal.msg" "materialInfo3.t" -na;
...
connectAttr "PxrCollar.msg" "hyperLayout1.hyp[0].dn";
connectAttr "PxrDisney1SG.msg" "hyperLayout1.hyp[1].dn";
connectAttr "PxrNameMetal.msg" "hyperLayout1.hyp[2].dn";
connectAttr "PxrLMMetal2SG.msg" "hyperLayout1.hyp[3].dn";
connectAttr ":renderManRISGlobals.msg" "hyperLayout1.hyp[4].dn";
connectAttr ":rmanFinalGlobals.msg" "hyperLayout1.hyp[5].dn";
connectAttr ":rmanFinalOutputGlobals0.msg" "hyperLayout1.hyp[6].dn";
connectAttr ":rmanRerenderRISGlobals.msg" "hyperLayout1.hyp[7].dn";
connectAttr ":rmanRerenderRISOutputGlobals0.msg" "hyperLayout1.hyp[8].dn";
connectAttr "PxrStuds.msg" "hyperLayout1.hyp[9].dn";
connectAttr "PxrLMMetal3SG.msg" "hyperLayout1.hyp[10].dn";
connectAttr "PxrGlitter.msg" "hyperLayout1.hyp[11].dn";
connectAttr "PxrLMMetal4SG.msg" "hyperLayout1.hyp[12].dn";
connectAttr "PxrManifold2D1.msg" "hyperLayout1.hyp[13].dn";
connectAttr "PxrVoronoise1.msg" "hyperLayout1.hyp[14].dn";
connectAttr "PxrClamp1.msg" "hyperLayout1.hyp[15].dn";
connectAttr "PxrTangentField1.msg" "hyperLayout1.hyp[16].dn";
connectAttr "PxrTexture1.msg" "hyperLayout1.hyp[17].dn";
connectAttr "PxrStuds.oc" "PxrLMMetal3SG.ss";
connectAttr "PxrLMMetal3SG.msg" "materialInfo4.sg";
connectAttr "PxrStuds.msg" "materialInfo4.m";
connectAttr "PxrStuds.msg" "materialInfo4.t" -na;
connectAttr "PxrTangentField1.resultXYZ" "PxrGlitter.shadingTangent";
connectAttr "PxrGlitter.oc" "PxrLMMetal4SG.ss";
connectAttr "pCubeShape1.iog" "PxrLMMetal4SG.dsm" -na;
connectAttr "pCubeShape2.iog" "PxrLMMetal4SG.dsm" -na;
connectAttr "pCubeShape3.iog" "PxrLMMetal4SG.dsm" -na;
connectAttr "pCylinderShape3.iog" "PxrLMMetal4SG.dsm" -na;
connectAttr "pCylinderShape2.iog" "PxrLMMetal4SG.dsm" -na;
connectAttr "PxrLMMetal4SG.msg" "materialInfo5.sg";
connectAttr "PxrGlitter.msg" "materialInfo5.m";
connectAttr "PxrGlitter.msg" "materialInfo5.t" -na;
connectAttr "PxrManifold2D1.result" "PxrVoronoise1.manifold";
connectAttr "PxrVoronoise1.resultF" "PxrClamp1.inputRGBr";
...
connectAttr "PxrLMMetal4SG.msg" "hyperLayout2.hyp[1].dn";
connectAttr ":renderPartition.msg" "hyperLayout2.hyp[2].dn";
connectAttr "PxrGlitter.msg" "hyperLayout2.hyp[3].dn";
connectAttr "PxrManifold2D1.msg" "hyperLayout2.hyp[4].dn";
connectAttr "PxrVoronoise1.msg" "hyperLayout2.hyp[5].dn";
connectAttr "PxrClamp1.msg" "hyperLayout2.hyp[6].dn";
connectAttr "PxrTangentField1.msg" "hyperLayout2.hyp[7].dn";
connectAttr "PxrTexture1.msg" "hyperLayout2.hyp[8].dn";
connectAttr "PxrTexture1.resultRGB" "PxrTangentField1.inputVector";
connectAttr "PxrManifold2D1.result" "PxrTexture1.manifold";
connectAttr "PxrLMMetal1SG.pa" ":renderPartition.st" -na;
connectAttr "PxrDisney1SG.pa" ":renderPartition.st" -na;
connectAttr "PxrLMMetal2SG.pa" ":renderPartition.st" -na;
connectAttr "PxrLMMetal3SG.pa" ":renderPartition.st" -na;
connectAttr "PxrLMMetal4SG.pa" ":renderPartition.st" -na;
connectAttr "PxrSteel.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrCollar.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrNameMetal.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrStuds.msg" ":defaultShaderList1.s" -na;
connectAttr "PxrGlitter.msg" ":defaultShaderList1.s" -na;
...
connectAttr "PxrTangentField1.msg" ":defaultTextureList1.tx" -na;
connectAttr "PxrTexture1.msg" ":defaultTextureList1.tx" -na;
// End of PIG_collar_pxr.ma
