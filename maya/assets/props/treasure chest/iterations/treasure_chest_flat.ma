...
//Name: treasure_chest_flat.ma
//Last modified: Sat, Feb 07, 2015 08:59:05 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.9381108498914081 3.9610747585980866 7.4638596381862898 ;
	setAttr ".r" -type "double3" -20.138352731224824 -10.999999999999176 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 8.3138698959337702;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.030876924608011391 1.4320906391362258 0.71968734039064375 ;
...
createNode mesh -n "polySurfaceShape32" -p "polySurface35";
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode mesh -n "polySurfaceShape37" -p "polySurface40";
	setAttr -k off ".v";
	setAttr -s 8 ".iog[0].og";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
