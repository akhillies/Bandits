...
//Name: taller_window_latest.ma
//Last modified: Wed, Dec 03, 2014 11:38:10 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 35.803010847310915 27.093741746484209 35.369100931611825 ;
	setAttr ".r" -type "double3" -27.804199881286522 44.999999999999986 0 ;
	setAttr ".rp" -type "double3" 0 -7.1054273576010019e-15 0 ;
	setAttr ".rpt" -type "double3" 1.9493861963967762e-16 4.2868785794736377e-16 2.4228591627419498e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 57.153867706024869;
...
createNode mesh -n "taller_windowShape" -p "taller_window";
	setAttr -k off ".v";
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "pasted__groupId71.id" "taller_windowShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "taller_windowShape.iog.og[0].gco";
connectAttr "pasted__groupId72.id" "taller_windowShape.iog.og[1].gid";
...
connectAttr "pasted__groupId72.msg" "window:lambert2SG.gn" -na;
...
// End of taller_window_latest.ma
