...
//Name: jump_out_window.ma
//Last modified: Sun, Dec 07, 2014 08:29:33 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.538194278014643 13.516772967639451 4.43884242849124 ;
	setAttr ".r" -type "double3" -15.804199881285466 -115.79999999999707 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 36.020986279769097;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 14.367342999999998 2.113769087551864 -5.04779030817323 ;
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 10.954790561631706 6.6005672784963965 -5.6528099351229519 ;
	setAttr ".r" -type "double3" -1.1999999999995183 -128.91263357726291 0 ;
...
createNode reference -n "sneaks_latestRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"sneaks_latestRN" 0
		"sneaks_latestRN" 11
		2 "|sneaks_latest:controller_root" "translate" " -type \"double3\" 41.647051 0 21.687559"
		
		2 "|sneaks_latest:controller_root" "rotate" " -type \"double3\" 0 -90 0"
		2 "|sneaks_latest:controller_root" "scale" " -type \"double3\" 0.64 0.64 0.64"
		...
		" -type \"double3\" 0 0 0"
		2 "|sneaks_latest:left_wrist" "translate" " -type \"double3\" 38.274308 -0.337088 22.982633"
		
		2 "|sneaks_latest:left_wrist" "rotate" " -type \"double3\" 104.923176 -88.128273 -101.476739"
		
		2 "|sneaks_latest:RightHandHandle" "translate" " -type \"double3\" 38.285935 -0.381772 19.331036"
		
		2 "|sneaks_latest:RightHandHandle" "rotate" " -type \"double3\" 176.203825 -84.099218 -175.599338";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "smarty_latestRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|smarty_latest:SmartyRig|smarty_latest:Smarty|smarty_latest:SMARTY|smarty_latest:SMARTYShape" 
		"displaySmoothMesh" " 2"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl" "translate" " -type \"double3\" 26.3874 9.440161 18.20875"
		
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl" "rotate" " -type \"double3\" 0 90 0"
		
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl" "scale" " -type \"double3\" 0.316 0.316 0.316"
...
createNode reference -n "tuffs_latestRN";
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"tuffs_latestRN" 0
		"tuffs_latestRN" 3
		2 "|tuffs_latest:controller_root" "translate" " -type \"double3\" 29.508068 0 19.063645"
