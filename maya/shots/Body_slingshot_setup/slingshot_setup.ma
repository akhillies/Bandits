...
//Name: slingshot_setup.ma
//Last modified: Mon, Dec 08, 2014 01:22:20 AM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 33.078880775160414 7.2999804104136299 27.472162356620316 ;
	setAttr ".r" -type "double3" -7.4041998812871341 47.000000000000448 -5.8294764102733254e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 26.867132953175958;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 7.0214843287884863 -3.3447916574343353 ;
...
createNode mesh -n "pPyramidShape1" -p "pPyramid1";
	...
	setAttr -s 6 ".pt[0:5]" -type "float3"  -5.8922376e-07 0 -0.9193663 
		4.4932885 -4.4408921e-16 -8.0373546e-08 1.9640791e-07 0 0.9193663 -4.4932885 0 -1.3775121e-15 
		-1.4393858e-14 0 1.6933357e-29 0 0 0;
	setAttr ".dr" 3;
	setAttr ".dsm" 2;
...
createNode hyperLayout -n "hyperLayout1";
	...
	setAttr ".hyp[20].nvs" 2144;
	setAttr ".hyp[21].nvs" 2144;
	setAttr ".hyp[22].nvs" 2144;
	setAttr ".hyp[23].nvs" 2112;
	setAttr ".hyp[24].nvs" 2112;
	setAttr ".hyp[25].nvs" 2112;
...
createNode reference -n "tuffs_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"tuffs_latestRN" 0
		"tuffs_latestRN" 22
		2 "|tuffs_latest:controller_root" "translate" " -type \"double3\" 14.615063 0 -5.710761"
...
createNode polyPyramid -n "polyPyramid1";
	setAttr ".w" 5.8638184763142505;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode animCurveTL -n "tuffs_latest:controller_root_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 14.61506341821557 48 14.61506341821557;
...
createNode animCurveTL -n "tuffs_latest:controller_root_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 11.810555026196226 48 -5.7107605619848867;
...
createNode animCurveTU -n "tuffs_latest:controller_root_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0.50324162122399219 48 0.50324162122399219;
...
createNode animCurveTL -n "pPyramid1_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 16.732582287731965 48 16.732582287731965
		 56 16.732582287731965;
createNode animCurveTL -n "pPyramid1_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0.31383095548822065 48 0.31383095548822065
		 56 0.31383095548822065;
createNode animCurveTL -n "pPyramid1_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 18.500915651288018 48 10.505296639091451
		 56 10.695454974978636;
createNode animCurveTU -n "pPyramid1_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 48 1 56 1;
	setAttr -s 3 ".kot[0:2]"  5 5 5;
createNode animCurveTA -n "pPyramid1_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 48 0 56 0;
...
createNode animCurveTA -n "pPyramid1_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 180 48 180 56 180;
...
createNode animCurveTU -n "pPyramid1_scaleZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 1 48 4.8423192718355628 56 4.7372316113216977;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
...
connectAttr "tuffs_latest:controller_root_visibility.o" "tuffs_latestRN.phl[10]"
		;
connectAttr "tuffs_latest:controller_leftArm_translateY.o" "tuffs_latestRN.phl[11]"
		;
connectAttr "tuffs_latest:controller_leftArm_translateZ.o" "tuffs_latestRN.phl[12]"
		;
connectAttr "tuffs_latest:controller_leftArm_translateX.o" "tuffs_latestRN.phl[13]"
		;
connectAttr "tuffs_latest:controller_leftArm_rotateX.o" "tuffs_latestRN.phl[14]"
		;
connectAttr "tuffs_latest:controller_leftArm_rotateY.o" "tuffs_latestRN.phl[15]"
		;
connectAttr "tuffs_latest:controller_leftArm_rotateZ.o" "tuffs_latestRN.phl[16]"
		;
connectAttr "tuffs_latest:controller_leftArm_scaleX.o" "tuffs_latestRN.phl[17]";
connectAttr "tuffs_latest:controller_leftArm_scaleY.o" "tuffs_latestRN.phl[18]";
connectAttr "tuffs_latest:controller_leftArm_scaleZ.o" "tuffs_latestRN.phl[19]";
connectAttr "tuffs_latest:controller_leftArm_visibility.o" "tuffs_latestRN.phl[20]"
		;
...
connectAttr "polyPyramid1.msg" "hyperLayout1.hyp[0].dn";
connectAttr "pPyramid1.msg" "hyperLayout1.hyp[1].dn";
connectAttr "pPyramidShape1.msg" "hyperLayout1.hyp[2].dn";
connectAttr "tuffs_latest:controller_root_translateX.msg" "hyperLayout1.hyp[3].dn"
		;
connectAttr "tuffs_latest:controller_root_translateY.msg" "hyperLayout1.hyp[4].dn"
		;
connectAttr "tuffs_latest:controller_root_translateZ.msg" "hyperLayout1.hyp[5].dn"
		;
connectAttr "tuffs_latest:controller_root_visibility.msg" "hyperLayout1.hyp[6].dn"
		;
connectAttr "tuffs_latest:controller_root_rotateX.msg" "hyperLayout1.hyp[7].dn";
connectAttr "tuffs_latest:controller_root_rotateY.msg" "hyperLayout1.hyp[8].dn";
connectAttr "tuffs_latest:controller_root_rotateZ.msg" "hyperLayout1.hyp[9].dn";
connectAttr "tuffs_latest:controller_root_scaleX.msg" "hyperLayout1.hyp[10].dn";
connectAttr "tuffs_latest:controller_root_scaleY.msg" "hyperLayout1.hyp[11].dn";
connectAttr "tuffs_latest:controller_root_scaleZ.msg" "hyperLayout1.hyp[12].dn";
connectAttr "tuffs_latest:controller_leftArm_translateX.msg" "hyperLayout1.hyp[13].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_translateY.msg" "hyperLayout1.hyp[14].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_translateZ.msg" "hyperLayout1.hyp[15].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_visibility.msg" "hyperLayout1.hyp[16].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_rotateX.msg" "hyperLayout1.hyp[17].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_rotateY.msg" "hyperLayout1.hyp[18].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_rotateZ.msg" "hyperLayout1.hyp[19].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_scaleX.msg" "hyperLayout1.hyp[20].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_scaleY.msg" "hyperLayout1.hyp[21].dn"
		;
connectAttr "tuffs_latest:controller_leftArm_scaleZ.msg" "hyperLayout1.hyp[22].dn"
		;
connectAttr "pPyramid1_translateX.msg" "hyperLayout1.hyp[23].dn";
connectAttr "pPyramid1_translateY.msg" "hyperLayout1.hyp[24].dn";
connectAttr "pPyramid1_translateZ.msg" "hyperLayout1.hyp[25].dn";
connectAttr "pPyramid1_visibility.msg" "hyperLayout1.hyp[26].dn";
connectAttr "pPyramid1_rotateX.msg" "hyperLayout1.hyp[27].dn";
connectAttr "pPyramid1_rotateY.msg" "hyperLayout1.hyp[28].dn";
connectAttr "pPyramid1_rotateZ.msg" "hyperLayout1.hyp[29].dn";
connectAttr "pPyramid1_scaleX.msg" "hyperLayout1.hyp[30].dn";
connectAttr "pPyramid1_scaleY.msg" "hyperLayout1.hyp[31].dn";
connectAttr "pPyramid1_scaleZ.msg" "hyperLayout1.hyp[32].dn";
connectAttr "pPyramidShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of slingshot_setup.ma
