...
//Name: body_tuffs_soap.ma
//Last modified: Mon, Jan 26, 2015 01:48:01 AM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".rpt" -type "double3" -4.0145203527677261e-14 -1.1253105213605063e-14 -5.8200661851495757e-15 ;
...
createNode transform -n "tuffs_soap_cam";
	...
	setAttr ".spt" -type "double3" 5.9164567891576052e-31 0 0 ;
...
createNode transform -n "NewKitchen_cam";
	setAttr ".t" -type "double3" -49.220570586615189 10.5 2.4194800340006273 ;
	setAttr ".r" -type "double3" 0 59.000000000000007 0 ;
createNode camera -n "NewKitchen_camShape" -p "NewKitchen_cam";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 0.66288546179052099;
	setAttr ".ow" 30;
	setAttr ".imn" -type "string" "camera1";
	setAttr ".den" -type "string" "camera1_depth";
	setAttr ".man" -type "string" "camera1_mask";
...
createNode reference -n "tuffs_latestRN";
	setAttr ".fn[0]" -type "string" "/Users/scai/Bandits/maya//assets/characters/tuffs/tuffs_latest.ma";
	setAttr -s 220 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
