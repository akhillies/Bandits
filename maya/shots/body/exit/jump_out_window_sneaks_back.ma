...
//Last modified: Tue, Dec 09, 2014 06:56:50 PM
//Codeset: UTF-8
...
createNode reference -n "sneaks_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translateZ" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_head" 
		"rotate" " -type \"double3\" 26.16171 0 0"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_head" 
		"rotateX" " -av"
		...
		"rotate" " -type \"double3\" 0 96.100992 0"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_tailbase" 
		"rotateX" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_tailbase" 
		"rotateY" " -av"
		...
		"translate" " -type \"double3\" 0.0318077 -1.391135 2.126768"
		2 "|sneaks_latest:controller_root|sneaks_latest:spine|sneaks_latest:Spine2|sneaks_latest:Spine3|sneaks_latest:Spine4|sneaks_latest:Shoulder|sneaks_latest:Neck" 
		"translateX" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:spine|sneaks_latest:Spine2|sneaks_latest:Spine3|sneaks_latest:Spine4|sneaks_latest:Shoulder|sneaks_latest:Neck" 
		"translateY" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:spine|sneaks_latest:Spine2|sneaks_latest:Spine3|sneaks_latest:Spine4|sneaks_latest:Shoulder|sneaks_latest:Neck" 
		"translateZ" " -av"
		2 "|sneaks_latest:left_wrist" "translate" " -type \"double3\" 41.298814 -0.33038 23.921979"
		
		2 "|sneaks_latest:left_wrist" "rotate" " -type \"double3\" -149.791255 -55.127515 123.680324"
		
		2 "|sneaks_latest:RightHandHandle" "translate" " -type \"double3\" 41.345173 -0.496384 17.868619"
		
		2 "|sneaks_latest:RightHandHandle" "rotate" " -type \"double3\" 37.701079 -51.910229 -55.841576"
...
createNode reference -n "smarty_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|smarty_latest:SmartyRig|smarty_latest:Smarty|smarty_latest:SMARTY|smarty_latest:SMARTYShape" 
		"displaySmoothMesh" " 2"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl" "translate" " -type \"double3\" 52.010726 26.331993 19.381298"
		...
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl" "rotate" " -type \"double3\" 249.979024 90 0"
...
createNode reference -n "tuffs_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -ci 1 -k 1 -dv 1 -smn 0 -smx 1 -at \"double\""
		2 "|tuffs_latest:controller_root" "translate" " -type \"double3\" 33.589704 -0.565671 21.357472"
		...
		" -type \"double3\" 0 2.642471 6.086285"
		...
		" -type \"double3\" -2.516413 7.06045 9.701195"
		...
		" -type \"double3\" -22.680284 0 -39.257368"
...
createNode animCurveTL -n "sneaks_latest:controller_rightLeg_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  1 2.4651903288156626e-30 6 2.4651903288156626e-30
		 48 2.4651903288156626e-30 54 -6.3108872417680972e-30 58 -2.4424917976696655e-15 62 -1.3961051019473725e-14
...
createNode animCurveTL -n "sneaks_latest:controller_leftLeg_translateX";
	...
	setAttr -s 6 ".ktv[0:5]"  1 2.4651903288156626e-30 6 2.4651903288156626e-30
		 48 2.4651903288156626e-30 54 -6.3108872417680972e-30 64 -2.0816681711721688e-14 68 -6.7053176943786003e-30;
