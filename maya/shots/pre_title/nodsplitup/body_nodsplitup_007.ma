...
//Name: body_nodsplitup_007.ma
//Last modified: Tue, Feb 17, 2015 10:18:08 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -196.53482751180567 6.0793411367067165 31.685046023047267 ;
	setAttr ".r" -type "double3" 175.49473361562087 116.19999999999881 -180.00000000000318 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 26.087783056320006;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -221.89762026575181 0.7458012888421186 27.48492602408643 ;
...
createNode reference -n "raccoons_splitup_setup:sneaks_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"blendParent1" " -ci 1 -k 1 -dv 1 -smn 0 -smx 1 -at \"double\""
		2 "|sneaks_latest:controller_root" "translate" " -type \"double3\" -234.964039 0.587666 16.910097"
		...
		2 "|sneaks_latest:controller_root" "rotate" " -type \"double3\" 4.127437 90 0"
		...
		" -type \"double3\" 0 -1.845475 0.456147"
		...
		"rotate" " -type \"double3\" -8.696722 1.071525 0.379407"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_head" 
		"rotateX" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_head" 
		"rotateY" " -av"
		...
		"rotate" " -type \"double3\" 68.363058 0.773033 0.430525"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_tailbase" 
		"rotateX" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_COG|sneaks_latest:controller_tailbase" 
		"rotateY" " -av"
		...
		" -type \"double3\" 0 -0.650137 0.125449"
		...
		" -type \"double3\" 0 0.312674 1.189992"
		...
		"rotate" " -type \"double3\" -4.891562 4.427075 0.4279"
		2 "|sneaks_latest:controller_root|sneaks_latest:spine|sneaks_latest:Spine2|sneaks_latest:Spine3|sneaks_latest:Spine4|sneaks_latest:Shoulder|sneaks_latest:Neck" 
		"rotateX" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:spine|sneaks_latest:Spine2|sneaks_latest:Spine3|sneaks_latest:Spine4|sneaks_latest:Shoulder|sneaks_latest:Neck" 
		"rotateY" " -av"
		...
		" -type \"double3\" 0 -0.779058 0.11017"
		...
		" -type \"double3\" 0 0.208287 1.175826"
		...
		"translate" " -type \"double3\" 0 -0.201253 -0.126744"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_rightArm|sneaks_latest:RightArm" 
		"translateX" " -av"
		2 "|sneaks_latest:controller_root|sneaks_latest:controller_rightArm|sneaks_latest:RightArm" 
		"translateY" " -av"
...
createNode animCurveTA -n "raccoons_splitup_setup:sneaks_latest:controller_head_rotateZ";
	...
	setAttr -s 14 ".ktv[0:13]"  1 0 10 0 12 0 16 0 19 1.4634304026441896
		 ...
		 40 -5.9786027388117722 42 1.7763097281172928 48 0.014814027689534626 50 0.014814027689534626
...
createNode reference -n "smarty_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -1.109411 0 0"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:cog_ctrl" 
		"rotateX" " -av"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:cog_ctrl" 
		"rotateY" " -av"
		...
		"rotate" " -type \"double3\" -7.192327 -19.383616 -0.87477"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:cog_ctrl|smarty_latest:back_ctrl|smarty_latest:chest_ctrl|smarty_latest:head_ctrl" 
		"rotateX" " -av"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:cog_ctrl|smarty_latest:back_ctrl|smarty_latest:chest_ctrl|smarty_latest:head_ctrl" 
		"rotateY" " -av"
		...
		"translate" " -type \"double3\" 0 -3.865996 -2.760021"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:rightArm_ctrl" 
		"translateX" " -av"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:rightArm_ctrl" 
		"translateY" " -av"
		...
		"translateZ" " -av"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:rightArm_ctrl" 
		"rotate" " -type \"double3\" 70.683943 0 0"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:rightArm_ctrl" 
		"rotateX" " -av"
		2 "|smarty_latest:SmartyRig|smarty_latest:global_ctrl|smarty_latest:rightArm_ctrl" 
		"rotateY" " -av"
...
createNode reference -n "tuffs_latestRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -0.0519028 -11.255506 -3.970303"
		2 "|tuffs_latest:controller_root|tuffs_latest:controller_COG|tuffs_latest:controller_head" 
		"rotateX" " -av"
		2 "|tuffs_latest:controller_root|tuffs_latest:controller_COG|tuffs_latest:controller_head" 
		"rotateY" " -av"
...
createNode animCurveTA -n "smarty_latest:head_ctrl_rotateX";
	...
	setAttr -s 14 ".ktv[0:13]"  1 -49.181905375886586 7 -17.763872298411979
		 ...
		 53 -2.5885194318733364 54 -4.379471987520458 56 -0.6015955229330201 58 -9.7896204380765326;
createNode animCurveTA -n "smarty_latest:head_ctrl_rotateY";
	...
	setAttr -s 14 ".ktv[0:13]"  1 21.882930005872783 7 -11.138495936655405
		 ...
		 53 -19.013882181614683 54 -15.217484993623824 56 -15.21748499362384 58 -12.251628924014604;
...
createNode animCurveTA -n "tuffs_latest:controller_COG_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  34 0 38 0 40 -7.3815140180488763 42 0 46 8.8876114217276658;
...
createNode animCurveTL -n "tuffs_latest:controller_rightLeg_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  37 0 41 1.1115019815512843 43 0.62996643896685711
...
createNode animCurveTL -n "tuffs_latest:RightLeg_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  40 1.5777218104420239e-29;
...
createNode animCurveTL -n "tuffs_latest:controller_leftArm_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  40 0 41 -6.3108872417680958e-30 42 -6.3108872417680958e-30
...
connectAttr "tuffs_latest:controller_rightArm_translateX.o" "tuffs_latestRN.phl[51]"
		;
connectAttr "tuffs_latest:controller_rightArm_translateY.o" "tuffs_latestRN.phl[52]"
		;
connectAttr "tuffs_latest:controller_rightArm_translateZ.o" "tuffs_latestRN.phl[53]"
		;
connectAttr "tuffs_latest:controller_rightArm_visibility.o" "tuffs_latestRN.phl[54]"
		;
