...
//Name: lookingAtHouse_002-1.ma
//Last modified: Sun, Dec 07, 2014 11:43:17 PM
//Codeset: UTF-8
...
createNode mentalrayOptions -s -n "miDefaultOptions";
	...
	setAttr ".shrd" 2;
	setAttr ".mb" 2;
	setAttr ".miSamplesQualityR" 0.25287356972694397;
...
createNode reference -n "outside_houseRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|outside_house:outside_house_latest:photo_frame:frame" "translate" " -type \"double3\" 15.40580142497200455 24.97318414192542946 -59.84378439863210275"
		...
		2 "|outside_house:camera_binoculars" "translate" " -type \"double3\" -37.37778879373850316 10.90478406496510466 -35.2502155424664565"
		...
		2 "|outside_house:camera_binoculars" "rotate" " -type \"double3\" -37.99846290828320861 -10.400000000000027 0"
		...
		"translate" " -type \"double3\" 10.96263830384056526 180.70725091756912661 489.84599866537161006"
		...
		2 "|outside_house:sneaks_latest:left_wrist" "translate" " -type \"double3\" -6.18119151956776758 62.88510533091448451 350.38530336060762238"
		
		2 "|outside_house:sneaks_latest:left_wrist" "rotate" " -type \"double3\" 3.28123364846127386 184.96091196581332383 1.84117576505884406"
		
		2 "|outside_house:sneaks_latest:RightHandHandle" "translate" " -type \"double3\" -0.55580164127987441 62.81763614180709965 349.84663601635492114"
		
		2 "|outside_house:sneaks_latest:RightHandHandle" "rotate" " -type \"double3\" 0.585519793702592 179.45252740056275798 0.45196687072135683"
...
createNode animCurveTU -n "camera_binoculars_visibility";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 1 4 1 27 1 31 1 51 1 55 1 77 1 80 1 105 1;
	setAttr -s 9 ".kit[5:8]"  2 9 9 9;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 2 5 5 
		5;
createNode animCurveTL -n "camera_binoculars_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -2.2037425037338196 4 18.343453241102772
		 27 18.343453241102772 31 -37.377788793738503 51 -37.377788793738503 55 47.9843912825445
		 77 47.9843912825445 80 50.727270768046544 105 50.727270768046544;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
createNode animCurveTL -n "camera_binoculars_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 58.245877976207922 4 24.075601691349927
		 27 24.075601691349927 31 10.904784064965105 51 10.904784064965105 55 9.7517290826811536
		 77 9.7517290826811536 80 6.1077103779118085 105 6.1077103779118085;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
createNode animCurveTL -n "camera_binoculars_translateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 329.31982750779099 4 -42.52835965812924
		 27 -42.52835965812924 31 -35.250215542466456 51 -35.250215542466456 55 38.31917195222097
		 77 38.31917195222097 80 12.372341440292566 105 12.372341440292566;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
createNode animCurveTA -n "camera_binoculars_rotateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 3.4015370917169014 4 3.4015370917169014
		 27 3.4015370917169014 31 -37.998462908283209 51 -37.998462908283209 55 -1.1999999999999997
		 77 -1.1999999999999997 80 -1.5312096346187953 105 -1.5312096346187953;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
createNode animCurveTA -n "camera_binoculars_rotateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0 4 0 27 0 31 -10.400000000000027 51 -10.400000000000027
		 55 -3.2 77 -3.2 80 -3.2 105 -3.2;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
createNode animCurveTA -n "camera_binoculars_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0 4 0 27 0 31 0 51 0 55 0 77 0 80 0.88653640626991648
		 105 0.88653640626991648;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
createNode animCurveTU -n "camera_binoculars_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 8.8009943096695338 4 8.8009943096695338
		 27 8.8009943096695338 31 8.8009943096695338 51 8.8009943096695338 55 8.8009943096695338
		 77 8.8009943096695338 80 8.8009943096695338 105 8.8009943096695338;
	setAttr -s 9 ".kit[5:8]"  2 18 18 18;
	setAttr -s 9 ".kot[5:8]"  2 18 18 18;
...
applyMetadata -fmt "raw" -v "channel\nname externalContentTable\nstream\nname v1.0\nindexType numeric\nstructure externalContentTable\n0\n\"outside_houseRN\" \"\" \"/Users/AkhilBatra/Documents/schoolStuff/junior/CNM190/animation/work/Bandits/maya//scenes/outside_house.ma\" 2165670544 \"/Users/AkhilBatra/Documents/schoolStuff/junior/CNM190/animation/work/Bandits/maya/scenes/outside_house.ma\" \"FileRef\"\nendStream\nendChannel\nendAssociations\n" 
		-scn;
// End of lookingAtHouse_002-1.ma
