...
createNode reference -n "outside_houseRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|outside_house:camera_binoculars" "translate" " -type \"double3\" 18.34345324110277176 24.07560169134992734 -42.52835965812924002"
		...
		"translate" " -type \"double3\" 10.96263830384056348 242.28972233619921894 556.04874588313441564"
...
createNode animCurveTU -n "camera_binoculars_visibility";
	...
	setAttr -s 9 ".kit[7:8]"  2 9;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 5 5 5 2 
		5;
createNode animCurveTL -n "camera_binoculars_translateX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -2.2037425037338196 4 18.343453241102772
		 27 18.343453241102772 31 -37.377788793738503 51 -37.377788793738503 55 50.727270768046544
		 77 50.727270768046544 80 47.9843912825445 105 47.9843912825445;
	setAttr -s 9 ".kit[7:8]"  2 18;
	setAttr -s 9 ".kot[7:8]"  2 18;
createNode animCurveTL -n "camera_binoculars_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 58.245877976207922 4 24.075601691349927
		 27 24.075601691349927 31 10.904784064965105 51 10.904784064965105 55 6.1077103779118085
		 77 6.1077103779118085 80 9.7517290826811536 105 9.7517290826811536;
	setAttr -s 9 ".kit[7:8]"  2 18;
	setAttr -s 9 ".kot[7:8]"  2 18;
createNode animCurveTL -n "camera_binoculars_translateZ";
	...
	setAttr -s 9 ".ktv[0:8]"  0 329.31982750779099 4 -42.52835965812924
		 27 -42.52835965812924 31 -35.250215542466456 51 -35.250215542466456 55 12.372341440292566
		 77 12.372341440292566 80 38.31917195222097 105 38.31917195222097;
	setAttr -s 9 ".kit[7:8]"  2 18;
	setAttr -s 9 ".kot[7:8]"  2 18;
createNode animCurveTA -n "camera_binoculars_rotateX";
	...
	setAttr -s 9 ".ktv[0:8]"  0 3.4015370917169014 4 3.4015370917169014
		 27 3.4015370917169014 31 -37.998462908283209 51 -37.998462908283209 55 -1.5312096346187953
		 77 -1.5312096346187953 80 -1.1999999999999997 105 -1.1999999999999997;
	setAttr -s 9 ".kit[7:8]"  2 18;
	setAttr -s 9 ".kot[7:8]"  2 18;
...
createNode animCurveTA -n "camera_binoculars_rotateZ";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0 4 0 27 0 31 0 51 0 55 0.88653640626991648
		 77 0.88653640626991648 80 0 105 0;
	setAttr -s 9 ".kit[7:8]"  2 18;
	setAttr -s 9 ".kot[7:8]"  2 18;
