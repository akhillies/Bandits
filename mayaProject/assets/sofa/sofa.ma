...
//Name: sofa.ma
//Last modified: Sat, Oct 25, 2014 02:25:22 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.43766986412501074 -2.5815816366144038 -0.32478285806638829 ;
	setAttr ".r" -type "double3" 16.46164727186747 -1175.7999999998322 2.5444437451708134e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 4.1931834928810634;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 18 ".pt";
	setAttr ".pt[31]" -type "float3" 0 -0.29588807 0 ;
	setAttr ".pt[35]" -type "float3" 0 -0.29588807 0 ;
	setAttr ".pt[890]" -type "float3" -0.014331111 -0.00052978756 -0.038097557 ;
	setAttr ".pt[891]" -type "float3" -0.040973023 -0.003032055 -0.003860448 ;
	setAttr ".pt[892]" -type "float3" -0.018949274 0.00037590737 0.03276778 ;
	setAttr ".pt[893]" -type "float3" 0.0039940109 0.0026982275 0.04080943 ;
	setAttr ".pt[894]" -type "float3" 0.023876457 0.0012427379 0.033941191 ;
	setAttr ".pt[895]" -type "float3" 0.040973023 0.003032055 -0.0030447121 ;
	setAttr ".pt[896]" -type "float3" 0.023876457 0.0017824754 -0.034888387 ;
	setAttr ".pt[897]" -type "float3" 0.0039940109 0.0023782388 -0.040809423 ;
	setAttr ".pt[898]" -type "float3" -0.0007970439 0.0018236641 -0.043845467 ;
	setAttr ".pt[899]" -type "float3" -0.022834755 -0.0019703568 -0.026571803 ;
	setAttr ".pt[900]" -type "float3" -0.036401805 -0.0028603144 0.0043302211 ;
	setAttr ".pt[901]" -type "float3" -0.020232324 0.0012558532 0.038222767 ;
	setAttr ".pt[902]" -type "float3" 0.00100303 0.0022172763 0.043845467 ;
	setAttr ".pt[903]" -type "float3" 0.022858588 0.00045059697 0.037926249 ;
	setAttr ".pt[904]" -type "float3" 0.036401805 0.0015851194 0.0064746002 ;
	setAttr ".pt[905]" -type "float3" 0.022641847 0.0028603144 -0.026275279 ;
	setAttr ".dr" 1;
...
createNode polyTweak -n "polyTweak2";
	setAttr ".uopa" yes;
	setAttr -s 17 ".tk";
	setAttr ".tk[70]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[71]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[72]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[73]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[74]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[75]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[76]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[77]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[78]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[79]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[80]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[81]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[82]" -type "float3" 0 7.8903155 0 ;
	setAttr ".tk[83]" -type "float3" 0 7.8903155 0 ;
...
createNode polyTweak -n "polyTweak3";
	setAttr ".uopa" yes;
	setAttr -s 14 ".tk";
	setAttr ".tk[98]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[99]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[100]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[101]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[102]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[103]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[104]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[105]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[106]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[107]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[108]" -type "float3" 0.45991227 0 0 ;
	setAttr ".tk[109]" -type "float3" 0.45991227 0 0 ;
...
createNode polyTweak -n "polyTweak4";
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[110]" -type "float3" 0.19301671 5.3996954 0.26566646 ;
	setAttr ".tk[111]" -type "float3" 0.19301671 5.3996954 0.26566646 ;
	setAttr ".tk[112]" -type "float3" 0.19301674 5.3996954 0.26566646 ;
	setAttr ".tk[113]" -type "float3" 0.19301671 5.3996954 0.26566646 ;
	setAttr ".tk[114]" -type "float3" 0.19301671 5.3996954 0.26566646 ;
	setAttr ".tk[115]" -type "float3" 0.19301674 5.3996954 0.26566646 ;
	setAttr ".tk[116]" -type "float3" 0.19301671 5.3996954 0.26566646 ;
	setAttr ".tk[117]" -type "float3" 0.19301674 5.3996954 0.26566646 ;
...
createNode polyTweak -n "polyTweak26";
	setAttr ".uopa" yes;
	setAttr -s 34 ".tk";
	setAttr ".tk[826]" -type "float3" -0.038238358 -0.0055659735 -0.008035874 ;
	setAttr ".tk[827]" -type "float3" -0.02357812 -0.0023896706 0.035114128 ;
	setAttr ".tk[828]" -type "float3" 0.0011133213 0.0014323012 0.043854419 ;
	setAttr ".tk[829]" -type "float3" 0.022510795 -0.0015196862 0.036527351 ;
	setAttr ".tk[830]" -type "float3" 0.038238358 0.0041747103 -0.0079870857 ;
	setAttr ".tk[831]" -type "float3" 0.022510795 0.0037741 -0.037546698 ;
	setAttr ".tk[832]" -type "float3" 0.0011133213 0.0055659735 -0.043854419 ;
	setAttr ".tk[833]" -type "float3" -0.018608022 0.0010541836 -0.04084998 ;
	setAttr ".tk[834]" -type "float3" -0.02931839 -0.0052155396 -0.033737298 ;
	setAttr ".tk[835]" -type "float3" -0.035442188 -0.0066712569 0.0082553234 ;
	setAttr ".tk[836]" -type "float3" -0.02796066 0.0039344295 0.04858214 ;
	setAttr ".tk[837]" -type "float3" -0.00045750034 0.0066712569 0.055795122 ;
	setAttr ".tk[838]" -type "float3" 0.028216824 0.0028432896 0.048323289 ;
	setAttr ".tk[839]" -type "float3" 0.035442188 0.0026694592 0.0082495287 ;
	setAttr ".tk[840]" -type "float3" 0.028027659 0.0027184554 -0.033478409 ;
	setAttr ".tk[841]" -type "float3" -0.0014429053 0.0021299967 -0.055795122 ;
	setAttr ".tk[842]" -type "float3" -0.030701924 -0.0032904129 -0.0064623039 ;
	setAttr ".tk[843]" -type "float3" -0.018931093 -0.00052200339 0.028260211 ;
	setAttr ".tk[844]" -type "float3" 0.00089383195 0.0019594643 0.035239778 ;
	setAttr ".tk[845]" -type "float3" 0.018074118 0.00020445712 0.029328156 ;
	setAttr ".tk[846]" -type "float3" 0.030701924 0.0031034057 -0.0064129266 ;
	setAttr ".tk[847]" -type "float3" 0.018074118 0.0023626054 -0.030146627 ;
	setAttr ".tk[848]" -type "float3" 0.00089383195 0.0032904129 -0.035239782 ;
	setAttr ".tk[849]" -type "float3" -0.014940557 0.0002814875 -0.032865647 ;
	setAttr ".tk[850]" -type "float3" -0.022824097 -0.0031117522 -0.026009964 ;
	setAttr ".tk[851]" -type "float3" -0.027223563 -0.0041391943 0.0063568344 ;
	setAttr ".tk[852]" -type "float3" -0.02121052 0.0024707553 0.037439615 ;
	setAttr ".tk[853]" -type "float3" -0.00016440972 0.0041391943 0.042978935 ;
	setAttr ".tk[854]" -type "float3" 0.021672808 0.0016495732 0.037205778 ;
	setAttr ".tk[855]" -type "float3" 0.027223563 0.0019856438 0.0063515836 ;
	setAttr ".tk[856]" -type "float3" 0.021501936 0.002480658 -0.025776152 ;
	setAttr ".tk[857]" -type "float3" -0.0013027664 0.0018150466 -0.042978939 ;
...
connectAttr "polySplitRing49.out" "pCubeShape1.i";
